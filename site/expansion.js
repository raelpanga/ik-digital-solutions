...
const services = [
  ...
  },
  {
    ...
    fr: {
      ...
      includes: ["Inventaire des systèmes, des données et des échanges actuels", "Connexions entre vos outils de comptabilité, de stock, de boutique et de paiement, selon les accès disponibles", "Reprise et nettoyage des données existantes, avec vérification par vos équipes", "Remplacement progressif : un parcours à la fois, avec retour arrière possible", "Documentation et formation pour que vos équipes suivent le changement"],
    ...
    en: {
      ...
      includes: ["An inventory of current systems, data and exchanges", "Connections between your accounting, stock, storefront and payment tools, subject to available access", "Migration and cleaning of existing data, verified by your team", "Progressive replacement: one workflow at a time, with rollback", "Documentation and training so your team can follow the change"],
