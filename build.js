...
function layout(o) {
  ...
  const desc = o.description || (o.lang === "fr" ? "Studio de développement basé dans le Kentucky, au service des entreprises congolaises : sites web, applications métier et paiement mobile money, déployés et supervisés sur des serveurs en RDC." : "Kentucky-based software studio serving Congolese businesses: websites, business applications and mobile money payments, deployed and monitored on servers in the DRC.");
...
/* multi-page demo sites generated by their own script */
const sitesDir = path.join(__dirname, "demos", "sites");
